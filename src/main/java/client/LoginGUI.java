...
public class LoginGUI {
	...
	private void initializeFrame() {
		...
		ImageIcon image = new ImageIcon(URL_DIR + "/src/main/resources/icons8-login-64.png");
	...
	private void initializeLabel() {
		JLabel lbWelcome = new JLabel("Login to chat with others\r\n");
		lbWelcome.setBounds(10, 11, 180, 14);
	...
	private void initializeButton() {
		...
		loginButton.setBounds(250, 78, 90, 29);
