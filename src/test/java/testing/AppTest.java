...
public class AppTest extends TestCase
{
    ...
    {
        ArrayList<String> test_code = RequestReceiver.get_one_info(
    ...
    {
        ArrayList<Peer> test_code = RequestReceiver.get_all_info(
            "<SESSION_ACCEPT>"
    ...
    {
        String test_code = RequestReceiver.get_inactive_info(
    ...
    {
        String test_code = RequestReceiver.get_text_msg_content(
